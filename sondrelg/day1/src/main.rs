...
fn main() {
    ...
    for i in &calories {
        if i > &most {
            third_most = second_most.clone();
            second_most = most.clone();
            most = i.clone();
    ...
    println!("The most calories was {} and was held by elf {}", most, max_index + 1);
    println!("The second most calories was {} and was held by elf {}", second_most, second_max_index + 1);
    println!("The third most calories was {} and was held by elf {}", most, third_max_index + 1);
